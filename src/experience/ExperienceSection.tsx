        ...
        <header className={styles.header}>
          <div>
            ...
            <p className={styles.intro}>
              Software, scientific analysis, data systems,
              automation, commerce, and technical leadership —
              connected by the same habit of understanding complex
              systems and making them work better.
            </p>
          </div>
